		...
		>
			<article className="flex z-5  absolute flex-row mx-4 ">
				<div className="flex-col mx-4 md:mx-8 xl:mx-16">
					...
					<p className="text-3xl md:text-5xl xl:text-6xl font-bold text-center content-center">
						Afetto
					</p>
				</div>
				<p className="z-5 text-xs md:text-2xl xl:text-3xl font-bold md:font-thin lg:w-1/2 lg:ml-8">
